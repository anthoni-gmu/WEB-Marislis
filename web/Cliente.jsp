                        ...
                        <div class="container">
                            ...
                            <div class="input-group mb-3">
                                <form action="../ClienteControl" method="post" class=" d-flex w-100">
                                    <div class="row w-100">
                                        <div class="col-6 ">
                                            <input type="text" required class="form-control" placeholder="Buscar empleado por codigo" name="cod" aria-label="Recipient's username" aria-describedby="button-addon2">
                                            <input class="btn btn-outline-success w-100" type="submit" id="button-addon2" name="acc" value="Buscar">
                                        </div>
...
y otra línea, o muchas líneas 
                                        <div class="col-6" id="mostrar">
                                            <table class="table table-light table-striped shadow  bg-body rounded border-1">
                                                Object[] busC = (Object[]) session.getAttribute("busC");
