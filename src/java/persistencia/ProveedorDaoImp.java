 ...
 * @author toni
 */
public class ProveedorDaoImp implements Serializable,ProveedorDao {
    ...
    public ProveedorDaoImp(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    @Override
    public List listar() {
        List lis=findProveedorEntities();
