 ...
 * @author toni
 */
public class ArticuloDaoImp implements Serializable, ArticuloDao {

    public ArticuloDaoImp() {
        this.emf = Persistence.createEntityManagerFactory("SuperMercadoPortocarreroPU");
    }

    public ArticuloDaoImp(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    @Override
    public List listar() {
        List lis = findArticuloEntities();
        List lista = new ArrayList();
        for (int i = 0; i < lis.size(); i++) {
            Articulo pro = (Articulo) lis.get(i);
