<%-- 
    Document   : Compra
    Created on : Jul 14, 2021, 11:32:42 PM
    Author     : toni
--%>
...
<html lang="es">
    ...
    <body class=" ">
        ...
        <main class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-12">
                    <h1 class="fw-bold text-center text-primary my-5">Nota de La Compra</h1>
                </div>
                        ...
                        <div class="card-body ">
                            ...
                            <c:form action="CompraControl">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <c:text property="ruc" styleClass="form-control" />
                                    <c:submit value="Buscar Proveedor" property="acc" styleClass="btn btn-secondary w-100"/>
